...
const http$4 = require$$0__default['default'];
...
var response$2 = class ServerlessResponse extends http$4.ServerResponse {
...
const Response$1 = response$2;

function common$1(cb) {
  return request => {
    const response = new Response$1(request);
...
var getFramework$1 = function getFramework(app) {
  if (typeof app.callback === 'function') {
    return common$1(app.callback());
  }

  if (typeof app.handle === 'function') {
    return common$1((request, response) => {
  ...
  if (app._core && typeof app._core._dispatch === 'function') {
    return common$1(app._core._dispatch({
      app
    }));
  }
  ...
  if (typeof app.inject === 'function') {
    return async request => {
      ...
      return Response$1.from(res);
    };
  }

  if (typeof app.main === 'function') {
    return common$1(app.main);
  }
...
const http$3 = require$$0__default['default'];

var request$2 = class ServerlessRequest extends http$3.IncomingMessage {
...
var createRequest$1 = (event, context, options) => {
...
var isBinary$1 = function isBinary(headers, options) {
...
var sanitizeHeaders$1 = function sanitizeHeaders(headers) {
...
const isBinary = isBinary$1;
const Response = response$2;
const sanitizeHeaders = sanitizeHeaders$1;

var formatResponse$1 = (event, response, options) => {
...
const finish = finish$1;
const getFramework = getFramework$1;
const getProvider = getProvider$1;
...
contentDisposition$1.exports.parse = parse$7;
...
var basename = require$$1__default['default'].basename;
...
var ReadStream = require$$0__default$5['default'].ReadStream;
...
const extname = require$$1__default['default'].extname;
const vary = vary$1.exports;
const only = only$1;
const util = require$$0__default$4['default'];
const encodeUrl = encodeurl;
const Stream = require$$1__default$1['default'];
...
var EventEmitter = require$$0__default$6['default'].EventEmitter;
...
var relative$1 = require$$1__default['default'].relative;
...
var crypto$1 = require$$0__default$7['default'];
...
var compare = lib;
var crypto = require$$0__default$7['default'];
...
var Keygrip = keygrip;
var http$2 = require$$0__default['default'];
var cache = {};
...
const util = require$$0__default$4['default'];
const createError = httpErrors.exports;
...
const URL = require$$0__default$1['default'].URL;
const net = require$$1__default$2['default'];
const accepts$1 = accepts;
const contentType$1 = contentType;
const stringify = require$$0__default$1['default'].format;
...
const debug$1 = src$1.exports('koa:application');
const onFinished = onFinished$2.exports;
const response = response$1.exports;
const compose$1 = koaCompose$1;
const context = context$1.exports;
const request = request$1.exports;
const statuses = statuses$1;
const Emitter = require$$0__default$6['default'];
const util = require$$0__default$4['default'];
const Stream = require$$1__default$1['default'];
const http$1 = require$$0__default['default'];
const only = only$1;
const convert = koaConvert;
const deprecate = depd_1('koa');
const { HttpError: HttpError$1 } = httpErrors.exports;
...
const { pathToRegexp: pathToRegexp$1, compile, parse } = require$$5;
const { parse: parseUrl, format: formatUrl } = require$$0__default$1['default'];
...
const debug = src.exports('koa-router');
